...
class Point:
    ...
    def make_point(n):
        ...
        t = float(input("Enter time {}:".format(n)))
        
        x = float(input("Enter the x position of the object at time {}:".format(n)))
        y = float(input("Enter the y position of the object at time {}:".format(n)))
        z = float(input("Enter the z position of the object at time {}:".format(n)))
...
class movingBody:
    ...
    def __init__(self,vX,vY,vZ,initX,initY,initZ,initT,endT):
...
def interpolatePoints(a, b):
    ...
    return movingBody(vX, vY, vZ, initX, initY, initZ, a.time, b.time)
...
def locateBodyRep2(body, time):
    ...
    print(f"At time {time:.2f} seconds the object is at({bodyX:.3f},{bodyY:.3f},{bodyZ:.3f})") 
...
def interpolateRange2(pts, body):
...
interpolateRange2(numberOfPoints, body)
